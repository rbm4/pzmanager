...
public class PagBankOrderDTO {
    ...
    public List<ErrorMessage> getError_messages() { return error_messages; }
    public void setError_messages(List<ErrorMessage> error_messages) { this.error_messages = error_messages; }
    ...
    public boolean isPaid() {
        ...
        if (qr_codes != null && !qr_codes.isEmpty()) {
            return qr_codes.stream().anyMatch(qr -> 
                qr.getArrangements() != null && !qr.getArrangements().isEmpty());
        }
    ...
    public static class QrCode {
        ...
        public void setArrangements(List<String> arrangements) { this.arrangements = arrangements; }
